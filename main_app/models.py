...
class Article(models.Model):
    SCIENTIFIC_FIELD_CHOICES = [
        ("Математика", "Математика"),
        ("Гидро- и аэродинамика, микромеханика", "Гидро- и аэродинамика, микромеханика"),
        ("Общая физика", "Общая физика"),
        ("Физика высоких энергий, ядерная физика", "Физика высоких энергий, ядерная физика"),
        ("Исследования космоса, астрофизика и астрономия", "Исследования космоса, астрофизика и астрономия"),
        ("Органическая и координационная химия", "Органическая и координационная химия"),
        ("Неорганическая химия, химия твердого тела, материаловедение", "Неорганическая химия, химия твердого тела, материаловедение"),
        ("Физическая химия, химическая физика, полимеры", "Физическая химия, химическая физика, полимеры"),
        ("Общая биология", "Общая биология"),
        ("Физико-химическая, молекулярная и клеточная биология, биотехнологии", "Физико-химическая, молекулярная и клеточная биология, биотехнологии"),
        ("География и окружающая среда", "География и окружающая среда"),
        ("Геология, геохимия, минералогия", "Геология, геохимия, минералогия"),
        ("Физика океана и атмосферы, геофизика", "Физика океана и атмосферы, геофизика"),
        ("Энергетика", "Энергетика"),
        ("Горные науки, горная инженерия и добыча полезных ископаемых", "Горные науки, горная инженерия и добыча полезных ископаемых"),
        ("Химические технологии, включая нефтехимию", "Химические технологии, включая нефтехимию"),
        ("Технологии материалов, металлургия", "Технологии материалов, металлургия"),
        ("Приборостроение и механика", "Приборостроение и механика"),
        ("Производственные технологии и технологии машиностроения", "Производственные технологии и технологии машиностроения"),
        ("Автомобиле-, авиа- и судостроение", "Автомобиле-, авиа- и судостроение"),
        ("Проектирование и строительство", "Проектирование и строительство"),
        ("Транспортные системы и технологии", "Транспортные системы и технологии"),
        ("Компьютерные науки, включая информационные и телекоммуникационные технологии, робототехнику", "Компьютерные науки, включая информационные и телекоммуникационные технологии, робототехнику"),
        ("Клиническая медицина и технологии первичной медицинской помощи", "Клиническая медицина и технологии первичной медицинской помощи"),
        ("Фундаментальная медицина", "Фундаментальная медицина"),
        ("Профилактическая и реабилитационная медицина", "Профилактическая и реабилитационная медицина"),
        ("Фармакология и фармацевтика", "Фармакология и фармацевтика"),
        ("Медицинские лабораторные и информационные технологии", "Медицинские лабораторные и информационные технологии"),
        ("Технологии растениеводства", "Технологии растениеводства"),
        ("Животноводство и ветеринарные науки", "Животноводство и ветеринарные науки"),
        ("Продукты питания и технологии их производства", "Продукты питания и технологии их производства"),
        ("Исторические науки, культурология, искусствоведение", "Исторические науки, культурология, искусствоведение"),
        ("Филологические науки", "Филологические науки"),
        ("Экономические науки, экономическая география", "Экономические науки, экономическая география"),
        ("Юридические науки", "Юридические науки"),
        ("Политология, международные отношения", "Политология, международные отношения"),
        ("Философские науки", "Философские науки"),
        ("Социология, демография", "Социология, демография"),
        ("Психология и педагогические науки", "Психология и педагогические науки"),
    ]
    ...
    scientific_field = models.CharField(
        max_length=255,
        choices=SCIENTIFIC_FIELD_CHOICES,
